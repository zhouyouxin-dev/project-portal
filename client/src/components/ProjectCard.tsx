...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-card transition-[transform,box-shadow,border-color] duration-200 hover:-translate-y-0.5 hover:shadow-card-hover focus-within:ring-2 focus-within:ring-ring/30 dark:hover:border-primary/30">
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        <div>
          ...
          <p className={`mt-1.5 flex items-center gap-1.5 text-xs font-medium ${typeTheme(project.type).text}`}>
